...
trait PlayFormatter {
  ...
  implicit def enumLikeFormatter[E <: EnumLike](implicit ev: EssentialEnumCompanion { type EnumLikeType = E }, base: Formatter[E#ValueType], tag: ClassTag[E]): Formatter[E] = new Formatter[E] {
   ...
   */
  implicit def enumLikePathBindable[E <: EnumLike](implicit ev: EssentialEnumCompanion { type EnumLikeType = E }, base: PathBindable[E#ValueType]): PathBindable[E] = new PathBindable[E] {
   ...
   */
  implicit def enumLikeQueryStringBindable[E <: EnumLike](implicit ev: EssentialEnumCompanion { type EnumLikeType = E }, base: QueryStringBindable[E#ValueType]): QueryStringBindable[E] = new QueryStringBindable[E] {
  ...
  implicit def enumLikeJavascriptLitteral[E <: EnumLike](implicit ev: EssentialEnumCompanion { type EnumLikeType = E }, base: JavascriptLitteral[E#ValueType]): JavascriptLitteral[E] = new JavascriptLitteral[E] {
